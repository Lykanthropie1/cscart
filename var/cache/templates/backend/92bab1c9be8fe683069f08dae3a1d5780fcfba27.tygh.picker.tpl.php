<?php /* Smarty version Smarty-3.1.21, created on 2021-12-22 23:50:41
         compiled from "C:\OpenServer\domains\cscart\design\backend\templates\views\products\components\picker\picker.tpl" */ ?>
<?php /*%%SmartyHeaderCode:66691587061c38fa176ab98-71398628%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '66691587061c38fa176ab98-71398628',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_61c38fa18bea32_64511639',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_61c38fa18bea32_64511639')) {function content_61c38fa18bea32_64511639($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_to_json')) include 'C:/OpenServer/domains/cscart/app/functions/smarty_plugins\\modifier.to_json.php';
?><?php
...
$_tmp15=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("pickers/products/picker.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('picker_id'=>((string)$_smarty_tpl->tpl_vars['advanced_picker_id']->value),'data_id'=>"om",'no_container'=>true,'icon'=>"icon-reorder",'but_text'=>$_tmp15,'show_but_text'=>false,'view_mode'=>"button",'meta'=>"object-picker__advanced-btn object-picker__advanced-btn--products ".((string)$_smarty_tpl->tpl_vars['object_picker_advanced_btn_class']->value)), 0);?>
...
$_tmp17=ob_get_clean();?><?php echo htmlspecialchars(fn_url("products.get_products_list?".$_tmp16.$_tmp17), ENT_QUOTES, 'UTF-8');?>
"
...
<?php $_tmp19=ob_get_clean();?><?php ob_start();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['result_title_post']->value, ENT_QUOTES, 'UTF-8');?>
<?php $_tmp20=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("views/products/components/picker/item_extended.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('type'=>"result",'title_pre'=>$_tmp19,'title_post'=>$_tmp20), 0);?>
...
<?php $_tmp22=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("views/products/components/picker/item_extended.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('type'=>"selection",'title_pre'=>$_tmp21,'title_post'=>$_tmp22), 0);?>
...
" data-no-defer="true" data-no-execute="§">
        <div class="cm-object-picker-object object-picker__selection object-picker__selection--products<?php if ($_smarty_tpl->tpl_vars['show_simple_product']->value) {?> object-picker__selection--simple-products<?php }?>">
            <?php ob_start();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['selection_title_pre']->value, ENT_QUOTES, 'UTF-8');?>
<?php $_tmp23=ob_get_clean();?><?php ob_start();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['selection_title_post']->value, ENT_QUOTES, 'UTF-8');?>
<?php $_tmp24=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("views/products/components/picker/item.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('type'=>"selection",'title_pre'=>$_tmp23,'title_post'=>$_tmp24), 0);?>
