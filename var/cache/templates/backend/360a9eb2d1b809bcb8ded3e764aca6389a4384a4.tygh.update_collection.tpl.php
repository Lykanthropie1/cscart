...
<?php /*%%SmartyHeaderCode:145790167561c38f9f0de824-77272937%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '145790167561c38f9f0de824-77272937',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_61c38f9f262980_75740523',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_61c38f9f262980_75740523')) {function content_61c38f9f262980_75740523($_smarty_tpl) {?><?php
...
" method="post" class="form-horizontal form-edit" name="collections_form" enctype="multipart/form-data">
...
" size="25" class="input-large" />
            ...
            <div class="control-group">
                <label for="elm_collection_position" class="control-label cm-required"><?php echo $_smarty_tpl->__("position_short");?>
</label>
                <div class="controls">
                    <input type="text" name="collection_data[position]" id="elm_collection_position" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['collection_data']->value['position'], ENT_QUOTES, 'UTF-8');?>
" size="25" class="input-large" />
                </div>
            </div>
...
"><?php echo $_smarty_tpl->__("creation_date");?>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $_smarty_tpl->getSubTemplate ("pickers/users/picker.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_text'=>$_smarty_tpl->__("add_recipients_from_users"),'data_id'=>"return_users",'but_meta'=>"btn",'input_name'=>"collection_data[user_id]",'item_ids'=>$_smarty_tpl->tpl_vars['collection_data']->value['user_id'],'placement'=>"right",'display'=>"radio",'view_mode'=>"single_button",'user_info'=>$_smarty_tpl->tpl_vars['u_info']->value), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
        ...
        <?php $_smarty_tpl->_capture_stack[0][] = array("adv_buttons", null, null); ob_start(); ?>
            <?php if (!$_smarty_tpl->tpl_vars['id']->value) {?>
                <?php echo $_smarty_tpl->getSubTemplate ("buttons/save_cancel.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_role'=>"submit-link",'but_target_form'=>"collections_form",'but_name'=>"dispatch[products.update_collection]"), 0);?>

            <?php } else { ?>
                <?php echo $_smarty_tpl->getSubTemplate ("buttons/save_cancel.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_name'=>"dispatch[products.update_collection]",'but_role'=>"submit-link",'but_target_form'=>"collections_form",'hide_first_button'=>$_smarty_tpl->tpl_vars['hide_first_button']->value,'hide_second_button'=>$_smarty_tpl->tpl_vars['hide_second_button']->value,'save'=>$_smarty_tpl->tpl_vars['id']->value), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('title'=>$_smarty_tpl->tpl_vars['id']->value ? $_smarty_tpl->tpl_vars['collection_data']->value['collection'] : ("Добавить новую коллекцию"),'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'adv_buttons'=>Smarty::$_smarty_vars['capture']['adv_buttons'],'buttons'=>Smarty::$_smarty_vars['capture']['buttons'],'select_languages'=>true), 0);?>
<?php }} ?>
