<?php /* Smarty version Smarty-3.1.21, created on 2022-01-11 13:29:19
         compiled from "C:\OpenServer\domains\cscart\design\themes\responsive\templates\addons\product_reviews\views\product_reviews\components\product_reviews_navigation.tpl" */ ?>
<?php /*%%SmartyHeaderCode:51365866661dd5bff4e1ae0-66799788%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '94e65ba309e404d8c58d0fe5007220a6ae380016' => 
    array (
  ...
  'nocache_hash' => '51365866661dd5bff4e1ae0-66799788',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_61dd5bff5be3a5_73332170',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_61dd5bff5be3a5_73332170')) {function content_61dd5bff5be3a5_73332170($_smarty_tpl) {?><?php if (!is_callable('smarty_function_set_id')) include 'C:/OpenServer/domains/cscart/app/functions/smarty_plugins\\function.set_id.php';
?><?php
...
$_tmp3=ob_get_clean();?><?php echo htmlspecialchars(fn_url(fn_link_attach($_smarty_tpl->tpl_vars['curl']->value,"with_images=".$_tmp3."&selected_section=product_reviews")), ENT_QUOTES, 'UTF-8');?>
"
    ...
    <nav class="ty-product-review-reviews-navigation">
        ...
        <label class="ty-product-review-reviews-navigation__filter <?php if ($_smarty_tpl->tpl_vars['product_reviews_with_images']->value) {?>ty-product-review-reviews-navigation__filter--active<?php }?>">
            ...
            <a id="product_review_with_images_link"
                href="<?php ob_start();
if ($_smarty_tpl->tpl_vars['product_reviews_with_images']->value) {?><?php echo "0";?><?php } else { ?><?php echo "1";?><?php }
$_tmp4=ob_get_clean();?><?php echo htmlspecialchars(fn_url(fn_link_attach($_smarty_tpl->tpl_vars['curl']->value,"with_images=".$_tmp4."&selected_section=product_reviews")), ENT_QUOTES, 'UTF-8');?>
"
                class="ty-product-review-reviews-navigation__filter-link cm-ajax"
                data-ca-target-id="pagination_contents_comments_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_id']->value, ENT_QUOTES, 'UTF-8');?>
"
